...
如果这个工具帮到了你 ☕ — [爱发电](https://ifdian.net/a/simonlin) · [Buy Me a Coffee](https://buymeacoffee.com/simonlin1212)。想要什么数据端点？欢迎开 [Issue](https://github.com/simonlin1212/global-stock-data/issues)，赞助者的 Issue 优先处理。
...
[Apache License 2.0](./LICENSE) — 自由使用，注明出处即可。**作者：** Simon 林 · 抖音「Simon林」 · 公众号「硅基世纪」
